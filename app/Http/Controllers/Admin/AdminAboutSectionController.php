...
class AdminAboutSectionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'main_image' => 'nullable|image|mimes:png,jpg,jpeg|max:10048',
            'main_image_alt' => 'nullable|string|max:255',
            'small_image' => 'nullable|image|mimes:png,jpg,jpeg|max:10048',
            'small_image_alt' => 'nullable|string|max:255',
            'icon_image' => 'nullable|image|mimes:png,jpg,jpeg|max:10048',
