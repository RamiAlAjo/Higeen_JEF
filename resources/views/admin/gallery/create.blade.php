...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create New Album</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control @error('album_description_en') is-invalid @enderror"
                                  ...
                                  rows="3">{{ old('album_description_en') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control @error('album_description_ar') is-invalid @enderror"
                                  ...
                                  rows="3"
                                  dir="rtl">{{ old('album_description_ar') }}</textarea>
