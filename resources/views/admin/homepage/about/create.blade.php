...
<div class="container-fluid mt-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0 fw-bold">Create About Section</h2>
    ...
    <form action="{{ route('admin.about-sections.store') }}" method="POST" enctype="multipart/form-data" novalidate>
        @csrf
                ...
                <div class="card shadow-sm rounded-3 p-4 mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            ...
                            id="paragraph_en"
                            placeholder="Enter Paragraph">{{ old('paragraph_en') }}</textarea>
                        @error('paragraph_en')
                ...
                <div class="card shadow-sm rounded-3 p-4 mb-4" dir="rtl">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            ...
                            id="paragraph_ar"
                            placeholder="أدخل الفقرة">{{ old('paragraph_ar') }}</textarea>
                        @error('paragraph_ar')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
        ...
        <div class="card shadow-sm rounded-3 p-4 mb-5">
            ...
            <div class="row gy-4">
                <div class="col-md-6">
                    ...
                    <img id="mainImagePreview" src="https://via.placeholder.com/300x150?text=Main+Image" alt="Main Image" class="img-fluid mt-3 rounded border shadow-sm" style="max-height: 150px; object-fit: contain;">
                    <div class="mt-2">
                ...
                <div class="col-md-6">
                    ...
                    <img id="smallImagePreview" src="https://via.placeholder.com/150?text=Small+Image" alt="Small Image" class="img-fluid mt-3 rounded border shadow-sm" style="max-height: 150px; object-fit: contain;">
                    <div class="mt-2">
